...
import { ToggleButton, Button } from 'react-native-paper';import Icon from 'react-native-vector-icons/MaterialCommunityIcons';
                ...
                <ScrollView style={styles.container}>
                    <View>
                        ...
                        <View style={styles.bottom}>
                            ...
                            <ToggleButton.Row>
                                <Button icon={() => <IconFacebook  width={15} height={25} fill="#ffffff" />} labelStyle={{ color: '#ffffff' }} color="#006400" style={{ marginRight: 10 }} compact mode="contained" onPress={() => Linking.openURL('https://www.facebook.com/acheiaquiali')}></Button>
                                <Button icon={() => <IconInstagram  width={15} height={25} fill="#ffffff" />} labelStyle={{ color: '#ffffff' }} color="#006400" style={{ marginRight: 10 }} compact mode="contained" onPress={() => Linking.openURL('https://www.instagram.com/acheiaquiali')}></Button>
                                <Button icon={() => <IconPhone  width={15} height={25} fill="#ffffff" />} labelStyle={{ color: '#ffffff' }} color="#006400" style={{ marginRight: 10 }} compact mode="contained" onPress={() => Linking.openURL('http://www.acheiaquiali.com.br')}>
